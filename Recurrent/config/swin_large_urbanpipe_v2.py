_base_ = [
    './swin/swin_large_v2.py', './default_runtime.py'
]
...
model=dict(
    backbone=dict(
        ...
        pretrained='/home/chenbeitao/data/code/mmlab/Video-Swin-Transformer/Recurrent/weight/swinv2_large_patch4_window12_192_22k.pth',
